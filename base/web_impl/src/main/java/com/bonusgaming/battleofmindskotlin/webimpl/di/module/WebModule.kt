package com.bonusgaming.battleofmindskotlin.webimpl.di.module

import com.bonusgaming.battleofmindskotlin.webapi.StickerApi
import com.bonusgaming.battleofmindskotlin.webapi.WebApi
import com.bonusgaming.battleofmindskotlin.webimpl.BuildConfig
import com.bonusgaming.battleofmindskotlin.webimpl.StickersApiRetrofit
import com.bonusgaming.battleofmindskotlin.webimpl.adapter.ToUrlStickerAdapter
...
open class WebModule : WebApi {
    ...
    /**
     * провайдим Picasso на слуйчай изменения конфигурации Picasso,
     * да и классы не должны знать о способе создания Picasso
     */
    @PerFacade
    @Provides
