...
import com.bonusgaming.battleofmindskotlin.features.avatar.di.component.CreatingAvatarComponent
...
class CreatingAvatarFragment : Fragment() {
    ...
    @Inject
    lateinit var viewModelFactory: CreatingAvatarViewModelFactory
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val uiComponent = UiComponent.get(appFacade)
        ...
        CreatingAvatarComponent.get(appFacade, uiComponent, web, db).inject(this)
